...
require (
	...
	github.com/adlandh/context-logger/sentry-extractor v1.4.8
	github.com/adlandh/echo-oapi-middleware/v2 v2.1.5
	github.com/adlandh/echo-sentry-middleware/v2 v2.1.2
	github.com/adlandh/echo-zap-middleware/v2 v2.1.2
	github.com/adlandh/gowrap-templates/helpers/sentry v1.2.6
...
require (
	...
	github.com/adlandh/find-interfaces v1.4.1 // indirect
