...
// GetMessage provides a mock function for the type ApplicationInterface
func (_mock *ApplicationInterface) GetMessage(ctx context.Context, id string) (string, time.Time, error) {
...
func (_c *ApplicationInterface_GetMessage_Call) RunAndReturn(run func(ctx context.Context, id string) (string, time.Time, error)) *ApplicationInterface_GetMessage_Call {
	_c.Call.Return(run)
	return _c
}

// ProcessRequest provides a mock function for the type ApplicationInterface
func (_mock *ApplicationInterface) ProcessRequest(ctx context.Context, url string, service string, msg string) error {
	ret := _mock.Called(ctx, url, service, msg)
	...
	if returnFunc, ok := ret.Get(0).(func(context.Context, string, string, string) error); ok {
		r0 = returnFunc(ctx, url, service, msg)
	} else {
		r0 = ret.Error(0)
	}
	return r0
...
func (_c *ApplicationInterface_ProcessRequest_Call) RunAndReturn(run func(ctx context.Context, url string, service string, msg string) error) *ApplicationInterface_ProcessRequest_Call {
	_c.Call.Return(run)
	return _c
}
